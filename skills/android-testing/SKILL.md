...
description: Use when working on Android or Jetpack Compose testing strategy, including unit, integration, Hilt, or screenshot testing, especially when the task needs concrete Android test structure rather than generic testing advice.
---
...
Use when the user:
- asks for Android or Jetpack Compose testing strategy
- needs help choosing between unit, integration, Hilt, or screenshot tests
- is adding or fixing Android tests and needs project structure or dependency guidance
- wants Android-specific testing examples rather than generic web or backend testing advice

## Boundaries

- Do not use for non-Android projects.
- Do not use when the task is generic regression orchestration without Android-specific concerns; prefer broader testing skills then.
- Do not use for browser-level UI testing or Playwright workflows.
