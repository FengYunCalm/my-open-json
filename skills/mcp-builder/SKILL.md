---
name: mcp-builder
description: Use when building or redesigning an MCP server that integrates external APIs or services, especially when tool design, API coverage, transport choice, or SDK implementation details matter.
