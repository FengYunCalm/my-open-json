---
name: compose-ui
description: Use when writing or refactoring Jetpack Compose UI, especially for Composable structure, state hoisting, modifiers, previews, performance, and theming in Android codebases.
---
...
Use when the user:
- asks for Jetpack Compose or Composable guidance
- is refactoring Compose UI structure or state hoisting
- needs Compose-specific performance or theming recommendations
- wants Android UI examples that are specific to Compose rather than XML views or web UI

## Boundaries

- Do not use for non-Compose Android UI or general frontend work.
- Do not use for generic testing tasks unless the main problem is specifically Compose UI structure.
